...
<template>
    <body class="contenedorperfil container-fluid">
        <div class="row">
        ...
        <div class="col-12 mt-3">
            <div class="offset-2 d-flex">
                ...
                <div class="profile-card-inf__item col-6">
                    <div class="profile-card-inf__title text-white">65</div>
                    <div class="profile-card-inf__txt">Following</div>
                </div>
            </div>
            <div class="offset-2 d-flex mt-4">
                <div class="profile-card-inf__item col-4">
                    <div class="profile-card-inf__title text-white">123</div>
                    <div class="profile-card-inf__txt">Posts</div>
                </div>

                <div class="profile-card-inf__item col-4 mx-4">
                    <div class="profile-card-inf__title text-white">85</div>
